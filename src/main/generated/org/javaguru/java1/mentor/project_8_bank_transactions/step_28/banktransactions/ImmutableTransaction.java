...
final class ImmutableTransaction
   ...
   *    .transactionType(org.javaguru.java1.mentor.project_8_bank_transactions.step_28.banktransactions.TransactionType) // required {@link Transaction#transactionType() transactionType}
   *    .build();
   * </pre>
