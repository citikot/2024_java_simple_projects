...
final class ImmutableTransaction
  ...
  private ImmutableTransaction(
    ...
    this.expenseCategory = Objects.requireNonNull(expenseCategory, "expenseCategory");
  }
  ...
  /**
   * @return The value of the {@code expenseCategory} attribute
   */
  @Override
  ...
  public final ImmutableTransaction withAmount(int value) {
    ...
    return new ImmutableTransaction(this, value, this.transactionType, this.expenseCategory);
  }
  ...
  public final ImmutableTransaction withTransactionType(TransactionType value) {
    ...
    return new ImmutableTransaction(this, this.amount, newValue, this.expenseCategory);
  }

  /**
   * Copy the current immutable object by setting a value for the {@link Transaction#expenseCategory() expenseCategory} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for expenseCategory
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableTransaction withExpenseCategory(ExpenseCategory value) {
    ExpenseCategory newValue = Objects.requireNonNull(value, "expenseCategory");
    if (this.expenseCategory == newValue) return this;
    return new ImmutableTransaction(this, this.amount, this.transactionType, newValue);
  }
  ...
  private boolean equalTo(int synthetic, ImmutableTransaction another) {
    return amount == another.amount
        ...
        && expenseCategory.equals(another.expenseCategory);
  }

  /**
   * Computes a hash code from attributes: {@code amount}, {@code transactionType}, {@code expenseCategory}.
  ...
  public int hashCode() {
    ...
    h += (h << 5) + expenseCategory.hashCode();
    return h;
  }
   ...
   * @param expenseCategory The value for the {@code expenseCategory} attribute
   * @return An immutable Transaction instance
   */
  public static ImmutableTransaction of(int amount, TransactionType transactionType, ExpenseCategory expenseCategory) {
    return new ImmutableTransaction(amount, transactionType, expenseCategory);
  }
   ...
   *    .transactionType(org.javaguru.java1.mentor.project_8_bank_transactions.step_37.banktransactions.TransactionType) // required {@link Transaction#transactionType() transactionType}
   *    .expenseCategory(org.javaguru.java1.mentor.project_8_bank_transactions.step_37.banktransactions.ExpenseCategory) // required {@link Transaction#expenseCategory() expenseCategory}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long INIT_BIT_EXPENSE_CATEGORY = 0x4L;
    ...
    /**
     * Initializes the value for the {@link Transaction#expenseCategory() expenseCategory} attribute.
     * @param expenseCategory The value for expenseCategory 
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder expenseCategory(ExpenseCategory expenseCategory) {
      this.expenseCategory = Objects.requireNonNull(expenseCategory, "expenseCategory");
      initBits &= ~INIT_BIT_EXPENSE_CATEGORY;
      return this;
    }
    ...
    public ImmutableTransaction build() {
      ...
      return new ImmutableTransaction(null, amount, transactionType, expenseCategory);
    }
    ...
    private String formatRequiredAttributesMessage() {
      ...
      if ((initBits & INIT_BIT_EXPENSE_CATEGORY) != 0) attributes.add("expenseCategory");
