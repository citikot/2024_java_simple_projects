...
final class ImmutableTransaction
   ...
   *    .transactionType(org.javaguru.java1.mentor.project_8_bank_transactions.step_36.banktransactions.TransactionType) // required {@link Transaction#transactionType() transactionType}
   *    .expenseCategory(org.javaguru.java1.mentor.project_8_bank_transactions.step_36.banktransactions.ExpenseCategory) // required {@link Transaction#expenseCategory() expenseCategory}
   *    .build();
   * </pre>
